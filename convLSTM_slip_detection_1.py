...
class ConvLSTM(nn.Module):
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        print last_state_list.size[0].size()
...
conv_lstm = ConvLSTM(shape, inp_chans, num_hidden, kernel_size, nlayers)
